...
(def MxLEDBitPCB-holder-central-hole-distance-from-bottom 7.12)
(def MxLEDBitPCB-holder-central-hole-distance-from-right 6.6) 
(def MxLEDBitPCB-holder-leg-thickness 2)
(def MxLEDBitPCB-holder-crush-rib-thickness 0.2)
(def MxLEDBitPCB-holder-leg-depth (* MxLEDBitPCB-holder-thickness 2))
(def MxLEDBitPCB-holder-leg-z-coordinate (-  (+ (/ MxLEDBitPCB-holder-leg-depth 2) 0.5)))
(def MxLEDBitPCB-holder-leg-position-1 [(+ (/ MxLEDBitPCB-holder-width 2) (/ MxLEDBitPCB-holder-leg-thickness 2))
                                        (- (/ MxLEDBitPCB-holder-length 2) 7.1)
...
(def MxLEDBitPCB-holder-leg-hook-coordinates-top [[0 (/ MxLEDBitPCB-holder-leg-thickness -2) 0] 
                                              [0 (/ MxLEDBitPCB-holder-leg-thickness -4) (+ (/ MxLEDBitPCB-holder-leg-thickness -4) (/ MxLEDBitPCB-holder-leg-depth -2))]
                                              [0 0 (+ (/ MxLEDBitPCB-holder-leg-thickness -2) (/ MxLEDBitPCB-holder-leg-depth -2))]
                                              [0 (/ MxLEDBitPCB-holder-leg-thickness 2) 0]])

(def MxLEDBitPCB-holder-leg-hook-coordinates-bottom [[0 (/ MxLEDBitPCB-holder-leg-thickness -2) (/ MxLEDBitPCB-holder-leg-depth -2)] [0 (/ MxLEDBitPCB-holder-leg-thickness 2) (/ MxLEDBitPCB-holder-leg-depth -2)]])
...
(def MxLEDBitPCB-holder-leg-hook
  ...
  (generate-bezier-along-bezier-polyhedron-from-points-list-linear
   ( apply bezier-cubic (concat (MxLEDBitPCB-holder-leg-hook-coordinates-to-the-left MxLEDBitPCB-holder-leg-hook-coordinates-top) [steps])) (apply bezier-linear (concat (MxLEDBitPCB-holder-leg-hook-coordinates-to-the-left MxLEDBitPCB-holder-leg-hook-coordinates-bottom) [steps]))
   (apply bezier-cubic (concat (MxLEDBitPCB-holder-leg-hook-coordinates-to-the-right MxLEDBitPCB-holder-leg-hook-coordinates-top) [steps])) (apply bezier-linear (concat (MxLEDBitPCB-holder-leg-hook-coordinates-to-the-right MxLEDBitPCB-holder-leg-hook-coordinates-bottom) [steps]))
   steps
   ))
...
(def MxLEDBitPCB-holder-crush-rib 
  (->>
   (binding [*fn* 36](cylinder [(/ MxLEDBitPCB-holder-crush-rib-thickness 2) MxLEDBitPCB-holder-crush-rib-thickness] MxLEDBitPCB-holder-leg-depth))
   (translate [0 (+ (/ MxLEDBitPCB-holder-leg-thickness 2) (/ MxLEDBitPCB-holder-crush-rib-thickness 2))]))
  )

(def MxLEDBitPCB-holder-leg 
   (union
   ; (cube MxLEDBitPCB-holder-leg-thickness MxLEDBitPCB-holder-leg-thickness MxLEDBitPCB-holder-leg-depth)
