...
(:refer-clojure :exclude [use import])
 ...
 (def tps-65-width-with-tolerance  (+ tps-65-width tps-65-tolerance 0.8))
 (def tps-65-length-with-tolerance (+ tps-65-length tps-65-tolerance 0.8))
 (def tps-65-depth-with-negative-tolerance  (- tps-65-depth tps-65-depth-tolerance 0.2))
 (def tps-65-width-with-negative-tolerance  (- tps-65-width tps-65-tolerance 0.2))
 (def tps-65-length-with-negative-tolerance (- tps-65-length tps-65-tolerance 0.2))
 (def tps-65-trackpad-only-thickness 1.25)
 (def tps-65-overlay-thickness 0.4)
...
(def tps-65-overlay-corner-cylinder-bottom-right
  ...
  (def tps-65-overlay
    (union
     (hull
    ;(cube tps-65-width tps-65-length tps-65-overlay-thickness)
...
(def tps-65-mount-corner-cylinder-bottom-right
 ...
 (def tps-65-mount-main-cutout 
   (hull
    tps-65-mount-corner-cylinder-top-left
    tps-65-mount-corner-cylinder-top-right
    tps-65-mount-corner-cylinder-bottom-left
    tps-65-mount-corner-cylinder-bottom-right
    ) 
   ) 
...
(def tps-65-mount-cutout
 ...
 (def tps-65-mount-body
  ...
  (def tps-65-mount 
    ...
    (->> tps-65-mount-body
    ;(call-module-with-block "fillet" {:fillet tps-65-corner-radius :size [(+ (- tps-65-width (* tps-65-corner-radius 2)) (* tps-65-mount-corner-radius-with-offset 2)) 
    ;                       (+ (- tps-65-length (* tps-65-corner-radius 2)) (* tps-65-mount-corner-radius-with-offset 2)) 
    ;                       tps-65-depth-with-tolerance] :edges "EDGES_Z_ALL" :$fn 24}
    ; 
    ; (call-module "cuboid" [(+ (- tps-65-width (* tps-65-corner-radius 2)) (* tps-65-mount-corner-radius-with-offset 2)) 
    ;                       (+ (- tps-65-length (* tps-65-corner-radius 2)) (* tps-65-mount-corner-radius-with-offset 2)) 
 ...
 (def tps-65-base
   (->> 
    (cube (+ tps-65-width tps-65-tolerance) (+ tps-65-length tps-65-tolerance) (+ tps-65-depth tps-65-depth-tolerance))
    (translate [0 0 (-(/ (+ tps-65-depth tps-65-depth-tolerance) 2))])
 ))
