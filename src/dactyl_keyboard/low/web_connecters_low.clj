...
:br-bm (return-value-type-fn "tr-tm")
    :centre (cond (and (pos? dx) (pos? dy)) (return-value-type-fn "bl")
                  (and (neg? dx) (pos? dy)) (return-value-type-fn "br")
                  (and (neg? dx) (neg? dy)) (return-value-type-fn "tr")
                  (and (pos? dx) (neg? dy)) (return-value-type-fn "tl")
                  (pos? dx) (return-value-type-fn "lm")
                  (pos? dy) (return-value-type-fn "bm")
                  (neg? dx) (return-value-type-fn "lm")
                  (neg? dy) (return-value-type-fn "tm"))))
  )
(comment 
