  ...
  (union
   ...
   (cond top-sphere
         (translate [0 0 (/ height 2)]
                    (->> (binding [*fn* 30] (sphere top-radius)))))
   ))
...
(defn fractyl-screw-insert [wall-position bottom-radius top-radius height 
  ...
  (let [wall-inner-floor-position (:wall-locate-2-bottom-floor (calculate-control-points wall-position))]
    (->> (fractyl-screw-insert-shape bottom-radius top-radius height :top-sphere top-sphere)
       (translate (mapv + offset wall-inner-floor-position [0 0 (/ height 2)]))))
  )
(def fractyl-screw-insert-bottom-radius (/ 4.4 2))
(def fractyl-screw-insert-outer-bottom-radius (+ fractyl-screw-insert-bottom-radius 1.65))
...
(def fractyl-screw-insert-holes  (fractyl-screw-insert-all-shapes fractyl-screw-insert-bottom-radius fractyl-screw-insert-top-radius fractyl-screw-insert-height :top-sphere false))
